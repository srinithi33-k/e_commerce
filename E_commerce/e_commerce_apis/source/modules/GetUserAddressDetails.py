...
from e_commerce_apis.source.common.query_constants import FETCH_USER_ADDRESS_DETAILS  
...
class GetUserAddressDetails:
    @staticmethod
    def get_user_address_details(request):
        try:
            ...
            query=FETCH_USER_ADDRESS_DETAILS  % field
