...
from e_commerce_apis.source.common.query_constants import FETCH_USER_order_DETAILS  
...
class GetUserOrderDetails:
    @staticmethod
    def get_user_order_details(request=None):
        try:
            ...
            query=FETCH_USER_order_DETAILS  % field
